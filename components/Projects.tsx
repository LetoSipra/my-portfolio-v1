    ...
    <>
      <div className="my-10 flex w-full flex-col space-y-10 px-5 sm:px-0">
        ...
        {projects.map((project) => (
          <div
            className={`project mx-auto mt-[136px] max-w-sm translate-y-52 items-center space-y-7 rounded-3xl border border-b border-black bg-black/25 px-2 py-5 font-mono tracking-wide text-gray-200 opacity-0 blur-xl filter transition duration-300 hover:border-b-red-500/75 sm:max-w-md md:max-w-lg lg:flex lg:max-w-5xl lg:space-x-2 lg:p-5 xl:mx-14 xl:p-10 xl:odd:flex-row-reverse xl:odd:self-end xl:even:self-start
            `}
            key={project.slug}>
